...
export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'ToanToan MERN Stack Board',
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://imgsrv.crunchyroll.com/cdn-cgi/image/fit=contain,format=auto,quality=85,width=1200,height=675/catalog/crunchyroll/a249096c7812deb8c3c2c907173f3774.jpe',
      ...
      },
      {
        ...
        cardOrderIds: ['column-id-04-placerholder-card'],
        cards: [
          {
            _id: 'column-id-04-placerholder-card',
            boardId: 'board-id-01',
